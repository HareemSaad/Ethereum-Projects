...
contract TokenBondingCurve_Exponential is ERC20, Ownable {
     ...
     * @param exponent_ The slope of the bonding curve.
     * This works for exponential curves like x^y with y being the variable user controls
     */
    constructor(
        string memory name_,
